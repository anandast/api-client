...
<form action="" method="post">
  ...
  <button type="button" class="btn btn-outline-dark btn-sm me-md-2" data-bs-toggle="modal" data-bs-target="#addCategories">
  ...
  <tbody>
    ...
    <tr>
      ...
      <form action="" method="post">
        @csrf
        @method('delete')
        <button type=button class="btn btn-outline-dark btn-sm"  data-bs-toggle="modal" data-bs-target="#deleteCategories{{$item['id']}}">
          <span data-feather="trash-2"></span>
        </button>
        <!-- Start Delete Categories Modal -->
        <div class="modal fade" id="deleteCategories{{$item['id']}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
